function [dt,tElapsed,speed,plotData,EvenHrIndices,timeLabels,lightON,lightOFF,motorON,motorOFF]=circadianGetPlots(motorID,speed,pix2mm,tStart,tON,tOFF,interval,stepSize)
